...
local defaults = {
	profile = {
		...
		macroBody = {
			...
			-- Daily quests ---------------------
			-- Skettis ------
			[L["Skettis Dailies"]] = defaultmacrolist["m_skettis"],
			[L["Blackwind Lake"]] = L["Skettis Dailies"],
			[L["Lower Veil Shil'ak"]] = L["Skettis Dailies"],
			[L["Skettis"]] = L["Skettis Dailies"],
			[L["Terokk's Rest"]] = L["Skettis Dailies"],
			[L["Upper Veil Shil'ak"]] = L["Skettis Dailies"],
			[L["Veil Ala'rak"]] = L["Skettis Dailies"],
			[L["Veil Harr'ik"]] = L["Skettis Dailies"],
			-- Ogri'La
			[L["Ogri'la Dailies"]] = defaultmacrolist["m_forgecamp"],
			[L["Forge Camp: Wrath"]] = L["Ogri'la Dailies"],
			[L["Forge Camp: Terror"]] = L["Ogri'la Dailies"],
			...
			[L["Sunwell Island Flaming Oil Dailies"]] = defaultmacrolist["m_flamingoil"],
			[L["The Sin'loren"]] = L["Sunwell Island Flaming Oil Dailies"],
			[L["The Dawnchaser"]] = L["Sunwell Island Flaming Oil Dailies"],
			[L["The Bloodoath"]] = L["Sunwell Island Flaming Oil Dailies"],
			...
			-- Wrath Dailies
			-- Howling Fjord
			[L["Fishy Fish Daily"]] = defaultmacrolist["m_fishyfish"],
			[L["Howling Fjord"]] = L["Fishy Fish Daily"],
			[L["Ledge of Garvan"]] = L["Fishy Fish Daily"],
			...
			-- The Storm Peaks
			[L["Sons of Hodir Essence of Ice Daily"]] = defaultmacrolist["m_essenceofice"],
			[L["Fjorn's Anvil"]] = L["Sons of Hodir Essence of Ice Daily"],
			[L["Frostfield Lake"]] = L["Sons of Hodir Essence of Ice Daily"],
			[L["The Forlorn Mine"]] = defaultmacrolist["m_discipline"],
			[L["Aberations Daily"]] = defaultmacrolist["m_aberations"],
			[L["The Blighted Pool"]] = L["Aberations Daily"],
			[L["Valkyrion"]] = L["Aberations Daily"],
			...
			[L["Argent Tournament Jousting Dailies"]] = defaultmacrolist["m_argentjousting"],
			[L["Argent Tournament Grounds"]] = L["Argent Tournament Jousting Dailies"],
			[L["The Horde Valiants' Ring"]] = L["Argent Tournament Jousting Dailies"],
			[L["The Argent Valiants' Ring"]] = L["Argent Tournament Jousting Dailies"],
			[L["The Alliance Valiants' Ring"]] = L["Argent Tournament Jousting Dailies"],
			[L["The Aspirants' Ring"]] = L["Argent Tournament Jousting Dailies"],
			[L["The Ring of Champions"]] = L["Argent Tournament Jousting Dailies"],
			[L["Argent Pavilion"]] = L["Argent Tournament Jousting Dailies"],
			[L["Silver Covenant Pavilion"]] = L["Argent Tournament Jousting Dailies"],
			[L["Sunreaver Pavilion"]] = L["Argent Tournament Jousting Dailies"],
			-- Shozalar Basin
