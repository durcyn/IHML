...
L["Skettis Dailies"] = true
L["Ogri'la Dailies"] = true
L["Sunwell Island Flaming Oil Dailies"] = true
L["Sons of Hodir Essence of Ice Daily"] = true
L["Aberations Daily"] = true
L["Argent Tournament Jousting Dailies"] = true
